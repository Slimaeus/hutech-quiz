...
let GenerateController = class GenerateController {
    ...
    [
        {{
            ...
            quizzes.forEach((e) => __awaiter(this, void 0, void 0, function* () {
                const formValues = new quiz_1.QuizFormValues();
                formValues.content = e.content;
                formValues.explaination = e.explaination;
                formValues.score = 1;
                formValues.answers = e.answers;
                yield this.quizzesService.create(formValues);
            }));
            console.log('Quizzes');
            console.log(quizzes);
            return quizzes;
...
GenerateController = __decorate([
    (0, typedi_1.Service)(),
    (0, routing_controllers_1.JsonController)("/api/v1/generate/:topic", { transformResponse: true }),
